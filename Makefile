...
DOCKER_ARGS_LOCAL = ${DOCKER_VOLUMES} ${DOCKER_X11_LOCAL} ${DOCKER_ENV_VARS} ${DOCKER_ENV_VARS_LOCAL} --privileged

DOCKER_ARGS_REMOTE = ${DOCKER_VOLUMES} ${DOCKER_X11_REMOTE} ${DOCKER_ENV_VARS}
